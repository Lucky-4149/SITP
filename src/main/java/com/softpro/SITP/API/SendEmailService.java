...
public class SendEmailService {
    ...
    public void ConfirmUserMail(String name, String pass, String mailTo, String testname, LocalDateTime starttime, int duration) {
    	...
    	String subject = "Online Test Scheduled - Softpro India";
        String message = "<html><body>" +
                         "<p>Dear " + name + ",</p>" +
                         "<p>Thank you for registering for <b>" + testname + "</b> by Softpro India. Below are the details:</p>" +
                         "<ul>" +
                         ...
                         "<p>Best of luck!</p>" +
                         "<p>Warm regards,<br>Softpro India</p>" +
                         "</body></html>";
